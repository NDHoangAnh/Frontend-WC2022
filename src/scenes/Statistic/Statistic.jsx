            ...
            {statistic && topGoal && (
                <div className='statistic'>
                    ...
                    {/* <div className="top-goal">
                        ...
                        <div className="top-goal-player">
                            {topGoal.map((player, index) => {
                                return (
                                    <div className='detail-top-goal-player'>
                                        <div key={index}><Player playerId={player?.idPlayer} /></div>
                                        <div className="num-goals">Số bàn thắng: {player.goal}</div>
                                    </div>
                                )
                            })}
                        </div>
                    ...
                    <div className="top-assist">
                        <div className='demo-top-assist'>Vua phá lưới</div>
                        <div className="top-assist-player">
                            {topAssist.map((player, index) => {
                                return (
                                    <div className='detail-top-assist-player'>
                                        <div key={index}><Player playerId={player?.idPlayer} /></div>
                                        <div className="num-assists">Số kiến tạo: {player.assist}</div>
                                    </div>
                                )
                            })}
                        </div>
                    ...
                    <div className="top-red">
                        ...
                        <div className="top-red-player">
                            {topRed.map((player, index) => {
                                return (
                                    <div className='detail-top-red-player'>
                                        <div key={index}><Player playerId={player?.idPlayer} /></div>
                                        <div className="num-reds">Số thẻ đỏ: {player.num_red_card}</div>
                                    </div>
                                )
                            })}
                        </div>
